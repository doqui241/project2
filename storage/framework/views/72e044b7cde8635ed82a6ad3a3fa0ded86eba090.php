        ...
        <form action="" method="post" class="addtb-form">
            ...
            <div class="button">
                <div class="text-center mt-3">
                    <button type="" class="btn btn-outline-warning button1 pt-3"  style="margin-right:24px;" ><a href="<?php echo e(route('dichvu.index')); ?>"  class="nav-link">Hủy</a></button>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Alta\quanly\resources\views/dichvu/adddv.blade.php ENDPATH**/ ?>