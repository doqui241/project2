        ...
        <div class="row">
            <div class="col-md-5 p-0  pt-5 bg-light dn ">
                ...
                <form action="<?php echo e(route('login.store')); ?>" class="p-0 mx-auto d-block" style="width:400px;" method="POST">
                    ...
                    <?php echo $__env->make('login.alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <div class=" mb-3"> 
...
<?php /**PATH C:\xampp\htdocs\Alta\quanly\resources\views/login/login.blade.php ENDPATH**/ ?>