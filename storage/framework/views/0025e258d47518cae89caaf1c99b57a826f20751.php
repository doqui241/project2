            ...
            <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>kết nối</td>
                        <td>khám tim mạch</td>
                        <td> <a href="" class="<?php echo e(route('thietbi.create')); ?>">Chi tiết</a></td>
                        <td><a href="<?php echo e(route('thietbi.create')); ?>" class="">Cập nhật</a></td>  
                    </tr>               
                </tbody>
              </table>
        </form>
        <div class="addtb">
            <a href="<?php echo e(route('thietbi.create')); ?>"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Alta\quanly\resources\views/thietbi/thietbi.blade.php ENDPATH**/ ?>