...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid m-3">
        ...
        <div class="addtb">
            <a href="<?php echo e(route('dichvu.create')); ?>"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Alta\quanly\resources\views/dichvu/dichvu.blade.php ENDPATH**/ ?>