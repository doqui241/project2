...
@section('content')
    <div class="container-fluid m-3">
        <div class="duongdan " style="margin-top:24px;">
            <p>Cài đặt hệ thống > <b style="color: #FF7506">Quản lý tài khoản</b></p>
        </div>
        <h4 style="color:#FF7506 " class=" mt-5">Danh sách tài khoản</h4>
        <div class="quanlyuser">
            ...
            <div class="tukhoa">
                <p>Từ Khóa</p>
                <input type="text" placeholder="Nhập từ khóa" class="tk" style="width:300px" name="" id="">
            </div>
        </div>
        ...
        <div class="addtb">
            <a href="{{route('quanlyuser.create')}}"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
