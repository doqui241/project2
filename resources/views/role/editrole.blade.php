...
@section('content')
    <div class="container-fluid m-3">
        ...
        <form action="{{route('role.update', $role->id)}}" method="POST" class="addtb-form">
            @csrf
            @method('PUT')
                ...
                <div class="row p-4 pt-0  pb-0">
                    <div class="col-md-6 p-3 pb-0">
                        <div class="mb-3">
                            ...
                            <input type="vaitro" class="form-control" id="" value="{{$role->name_role}}" placeholder="Nhập tên vai trò" name="name_role">
                        </div>
                        <div class="mb-3">
                            <label for="mota" class="form-label" >Mô tả:*</label>
                            <input type="mota" class="form-control" value="{{$role->mota_role}}" style="height: 150px" id="" placeholder="Nhập mô tả" name="mota_role">
                        </div>
