...
@section('content')
    <div class="container-fluid m-3">
        ...
        <form action="{{route('dichvu.update', $dichvu->id)}}" method="post" class="addtb-form">
            @csrf
            @method('PUT')
                ...
                <div class="row p-4 pt-0  pb-0">
                    ...
                    <div class="col-md-6 p-3  pb-0">
                        <div class="mb-3">
                            ...
                            <input type="mota" value="{{$dichvu->mota}}" class="form-control" id="mota" placeholder="Mô tả" name="mota">
                        </div>
                    </div>
